...
mixin _$UserDoc {
 ...
 String get uid; String get email; String get usn; String get fullName;@JsonKey(unknownEnumValue: UserRole.student) UserRole get role; bool get profileComplete; String? get phone; String? get yearOfStudy; String? get batch; String? get instagramHandle; String? get personalWebsite; String? get profilePictureUrl; int? get avatarId; String? get bio; List<String> get skills; String? get githubUrl; String? get linkedinUrl; String? get twitterHandle; String? get discordHandle; String? get status;// e.g. pending_batch_review
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,email,usn,fullName,role,profileComplete,phone,yearOfStudy,batch,instagramHandle,personalWebsite,profilePictureUrl,avatarId,bio,const DeepCollectionEquality().hash(skills),githubUrl,linkedinUrl,twitterHandle,discordHandle,status,mustResetPassword,facultyId,designation,club,fcmToken,privacySettings,notificationSettings,createdAt]);

@override
String toString() {
  return 'UserDoc(uid: $uid, email: $email, usn: $usn, fullName: $fullName, role: $role, profileComplete: $profileComplete, phone: $phone, yearOfStudy: $yearOfStudy, batch: $batch, instagramHandle: $instagramHandle, personalWebsite: $personalWebsite, profilePictureUrl: $profilePictureUrl, avatarId: $avatarId, bio: $bio, skills: $skills, githubUrl: $githubUrl, linkedinUrl: $linkedinUrl, twitterHandle: $twitterHandle, discordHandle: $discordHandle, status: $status, mustResetPassword: $mustResetPassword, facultyId: $facultyId, designation: $designation, club: $club, fcmToken: $fcmToken, privacySettings: $privacySettings, notificationSettings: $notificationSettings, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String uid, String email, String usn, String fullName,@JsonKey(unknownEnumValue: UserRole.student) UserRole role, bool profileComplete, String? phone, String? yearOfStudy, String? batch, String? instagramHandle, String? personalWebsite, String? profilePictureUrl, int? avatarId, String? bio, List<String> skills, String? githubUrl, String? linkedinUrl, String? twitterHandle, String? discordHandle, String? status, bool mustResetPassword, String? facultyId, String? designation, String? club, String? fcmToken, PrivacySettings privacySettings, NotificationSettings notificationSettings,@DateTimeConverter() DateTime? createdAt
});
...
/// Create a copy of UserDoc
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? email = null,Object? usn = null,Object? fullName = null,Object? role = null,Object? profileComplete = null,Object? phone = freezed,Object? yearOfStudy = freezed,Object? batch = freezed,Object? instagramHandle = freezed,Object? personalWebsite = freezed,Object? profilePictureUrl = freezed,Object? avatarId = freezed,Object? bio = freezed,Object? skills = null,Object? githubUrl = freezed,Object? linkedinUrl = freezed,Object? twitterHandle = freezed,Object? discordHandle = freezed,Object? status = freezed,Object? mustResetPassword = null,Object? facultyId = freezed,Object? designation = freezed,Object? club = freezed,Object? fcmToken = freezed,Object? privacySettings = null,Object? notificationSettings = null,Object? createdAt = freezed,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _UserDoc() when $default != null:
return $default(_that.uid,_that.email,_that.usn,_that.fullName,_that.role,_that.profileComplete,_that.phone,_that.yearOfStudy,_that.batch,_that.instagramHandle,_that.personalWebsite,_that.profilePictureUrl,_that.avatarId,_that.bio,_that.skills,_that.githubUrl,_that.linkedinUrl,_that.twitterHandle,_that.discordHandle,_that.status,_that.mustResetPassword,_that.facultyId,_that.designation,_that.club,_that.fcmToken,_that.privacySettings,_that.notificationSettings,_that.createdAt);case _:
  return orElse();
...
class _UserDoc implements UserDoc {
  const _UserDoc({required this.uid, this.email = '', this.usn = '', this.fullName = '', @JsonKey(unknownEnumValue: UserRole.student) this.role = UserRole.student, this.profileComplete = false, this.phone, this.yearOfStudy, this.batch, this.instagramHandle, this.personalWebsite, this.profilePictureUrl, this.avatarId, this.bio, final  List<String> skills = const [], this.githubUrl, this.linkedinUrl, this.twitterHandle, this.discordHandle, this.status, this.mustResetPassword = false, this.facultyId, this.designation, this.club, this.fcmToken, this.privacySettings = const PrivacySettings(), this.notificationSettings = const NotificationSettings(), @DateTimeConverter() this.createdAt}): _skills = skills;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,email,usn,fullName,role,profileComplete,phone,yearOfStudy,batch,instagramHandle,personalWebsite,profilePictureUrl,avatarId,bio,const DeepCollectionEquality().hash(_skills),githubUrl,linkedinUrl,twitterHandle,discordHandle,status,mustResetPassword,facultyId,designation,club,fcmToken,privacySettings,notificationSettings,createdAt]);
